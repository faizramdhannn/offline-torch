                      ...
                      <table className="w-full text-xs">
                        <thead className="bg-gray-100 border-b">
                          <tr>
                            ...
                            <th className="px-2 py-2 text-center font-semibold text-gray-700 w-28">Customer</th>
                            <th className="px-2 py-2 text-center font-semibold text-gray-700 w-24">Store</th>
