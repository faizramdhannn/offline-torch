...
export function ImportCsvModal({ onClose, onImport, importing }: ImportCsvModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={onClose}>
      <div className="w-full max-w-md rounded-xl bg-white p-5 shadow-xl" onClick={(e) => e.stopPropagation()}>
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-sm font-semibold text-gray-800">Import Shopify CSV</h2>
        ...
        {file ? (
          ...
          >
            ...
            <p className="text-[11px] text-gray-400">Export order Shopify (.csv)</p>
          </div>
        )}

        <p className="mt-3 text-[11px] text-gray-400">
          Order dengan sales order yang sama tidak akan terduplikasi — data yang sudah ada akan
          diperbarui, bukan ditambahkan lagi.
        </p>
