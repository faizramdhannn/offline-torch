      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-gray-200 bg-gray-50">
            <th className="px-2 py-2 text-left text-[10px] font-semibold uppercase tracking-wide text-gray-500">Time</th>
            <th className="px-2 py-2 text-left text-[10px] font-semibold uppercase tracking-wide text-gray-500">Action</th>
            <th className="px-2 py-2 text-left text-[10px] font-semibold uppercase tracking-wide text-gray-500">Entry ID</th>
            <th className="px-2 py-2 text-left text-[10px] font-semibold uppercase tracking-wide text-gray-500">By</th>
            <th className="px-2 py-2 text-left text-[10px] font-semibold uppercase tracking-wide text-gray-500">Notes / Changes</th>
            <th className="px-2 py-2 text-left text-[10px] font-semibold uppercase tracking-wide text-gray-500">Snapshot</th>
            <th className="px-2 py-2 text-left text-[10px] font-semibold uppercase tracking-wide text-gray-500">Actions</th>
          </tr>
        </thead>
          ...
          {items.map((item) => {
            ...
            return (
              <tr key={item.history_id} className="transition-colors hover:bg-gray-50">
                <td className="whitespace-nowrap px-2 py-1.5 text-[11px] text-gray-500">{formatDateTime(item.action_at)}</td>
                <td className="px-2 py-1.5">
                  <Badge variant={ACTION_VARIANT[item.action] ?? "neutral"}>{item.action}</Badge>
                </td>
                <td className="px-2 py-1.5 font-mono text-[11px] text-gray-700">{item.petty_cash_id}</td>
                <td className="px-2 py-1.5 text-[11px] font-medium text-gray-700">{item.action_by}</td>
